...
public class ReportController implements Initializable , GeneralOperations {
    ...
    void send_Action(ActionEvent event) {
        ListenerController.getListenerController().reportArtist(artistName_text.getText(),description_text.getText());
        HelloApplication.getStage().setScene(Detail.lastScene.peek());
    }

    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        artistName_text.setText(Detail.selectArtist.getUserName());
