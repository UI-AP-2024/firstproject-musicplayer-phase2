...
public class SignUpSingerController implements Initializable {
    ...
    void register_action(ActionEvent event) {
        try {
            SignInOutController.getUserAccountController().sinUpSinger(usernameField.getText(), passwordField.getText(), nameField.getText(), emailField.getText(), phoneNumberField.getText(), birthDatePicker.getText(), bioField.getText());
