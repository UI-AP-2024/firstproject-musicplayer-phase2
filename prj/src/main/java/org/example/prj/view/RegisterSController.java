...
public class RegisterSController implements Initializable {
    ...
    void mainRegister_Action(ActionEvent event) throws IOException {
        String result = ArtistController.getArtistController().registration("S",username_text.getText(),password_text.getText(),name_text1.getText(),email_text.getText(),number_text.getText(),year_text.getText(),month_text.getText(),day_text.getText(),bio_text.getText());
